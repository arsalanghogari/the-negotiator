...
export const autobody = {
  ...
  sellers: [
    ...
    },
    {
      ...
      systemPrompt:
        'You are an auto body shop estimator on a phone call with a caller requesting a repair estimate. Ask about details you need (year/make/model, what happened, which panels, lights working) one question at a time, like a real estimator. UPSELLER strategy: open around $1,600 itemized, but push OEM-parts upgrade, full-vehicle detail, and a "priority bay" fee hard. Drop the add-ons and about $200 off if the caller firmly declines extras and mentions a competing quote; you can make that final number binding. Stay in character, disclose real (fictional) numbers only, never break the negotiation. Speak naturally, 1-3 sentences per turn.',
    },
    {
